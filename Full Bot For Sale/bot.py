...
#———–———–———–———–———–———#
bot = telebot.TeleBot("6970943600:AAEwEyhGU_Rz6kYjTnlgI9KssYFhKAKEMw0", parse_mode='html')
admin_id = 6297075167

bot.send_message(admin_id,"Started")
iD = ["6297075167","-1001971321750"]
bot_working = True
